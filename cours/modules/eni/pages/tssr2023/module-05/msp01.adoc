...
* [ ] 3.2.3 Pour éviter tout problème de confidentialité, chaque dossier ne sera accessible en lecture et écriture qu’aux seuls membres de chaque groupe.
...
[none]
* -> xref:tssr2023/module-05/linux.adoc#mise-en-place-dossier-services[Procédure: Mise en place dossier service (Linux)]