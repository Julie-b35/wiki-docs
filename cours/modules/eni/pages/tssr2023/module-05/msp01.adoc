...
* -> xref:tssr2023/module-05/windows.adoc#[Procédure: Partitionnement 2^ème^ (Windows)]
...
* -> xref:tssr2023/module-05/linux.adoc#[Procédure: Partitionnement 2^ème^ (Windows)]