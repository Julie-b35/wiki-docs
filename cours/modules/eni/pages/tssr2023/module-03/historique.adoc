...
:var-link-UnixHistory: https://upload.wikimedia.org/wikipedia/commons/7/77/Unix_history-simple.svg

image::{var-link-UnixHistory}[history,640,418, link={var-link-UnixHistory}]
