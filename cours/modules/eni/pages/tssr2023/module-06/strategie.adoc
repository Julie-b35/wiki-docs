...
* xref:tssr2023/module-06/strategie.adoc#[*La gestion de la continuité*]
...
• Business Continuity Plan (Plan de Continuité d’Activité en Français) : orienté
métier, quelles sont les activités opérationnelles et leurs ressources que vaisje
maintenir ?
• Business Continuity Managment : analyse et gestion, quels sont les risques
et leurs impacts ?
• Business Impact Analysis : méthode d’analyse de l’impact business qui
permet d’évaluer les pertes potentielles.
• Disaster Recovery Plan (Plan de Reprise d’Activité en Français) : plan de
rétablissement et reprise informatique.