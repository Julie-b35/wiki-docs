=  TP 3/5 Packet Tracer : Mise en œuvre de la connectivité de base
...
----
|Avez-vous réussi ? Expliquez votre réponse. (*Non car l'ip de S1 n'est pas configuré.*)
|===
