...
|===
.3+|a.     | Sélectionnez *End Devices* dans les options proposées en bas à gauche. Faites glisser et déplacez trois ordinateurs génériques dans la zone de conception.
