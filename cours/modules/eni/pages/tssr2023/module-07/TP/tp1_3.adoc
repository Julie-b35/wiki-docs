...
|===
.13+| a. |Saisissez show arp à l'invite.
a|
[source,bash]
----
ISPRouter>show arp 
...
----
|Notez les adresses MAC et IP indiquées. (*IP : 209.165.201.1, MAC :  0060.70B4.A601*)
...
----
|Notez l'image IOS indiquée : (*c1900-universalk9-mz.SPA.151-4.M4.bin*)
