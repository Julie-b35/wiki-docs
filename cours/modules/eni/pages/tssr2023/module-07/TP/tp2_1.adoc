= TP 1/6 Packet Tracer : Configuration VLAN
...
[TIP,caption=Réponse]
====
Les requête Icmp ne fonctionnent pas car il n'y a pas de liaison trunk Point à point définis entre S1, S2 et S1, S2.
====
